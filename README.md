...
Backend is built on top of my custom CRUD Event Bundle. Frontend is separated from the backend and was auto-generated by `Lovable` primarily for API/backend demonstration purposes.
